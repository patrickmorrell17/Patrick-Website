'use client';
import {Title, Image, Text, List, Card, Blockquote} from "@mantine/core";
...
export default function WelcomeTab() {
  const rocketIcon = <IconRocket />;
  return (
    <>
      <div className={welcomeTab.homeBackground}>
        ...
        <div className={welcomeTab.details}>
          ...
          <Blockquote icon = {rocketIcon}><Title order={3}>{staticText.header} </Title>{staticText.introPara}</Blockquote>
        </div>
        <div className={welcomeTab.experience}>
            <Title order={3}>Relevant Experience</Title>
          <Card color="blue" withBorder shadow="lg" padding="xl">
